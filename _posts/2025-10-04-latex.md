---
layout: post
title:  "How to use LaTeX in Jekyll Blogs?"
date:   2025-10-04 16:12:00 +0800
tags: [LaTeX, MathJax, Mathematical Typesetting, Equations, Jekyll]
description: "Complete guide to using LaTeX and MathJax for mathematical typesetting in Jekyll blogs. Learn how to write equations, formulas, and mathematical notation with examples."
math: true
tikz: true
---
...
<pre><code># Blog里可以显示公式 :)</code></pre>
  </div>
  <div class="md-demo-pane md-demo-result">
    <span class="md-demo-label">Rendered</span>
    <div class="demo-heading demo-h1">Blog里可以显示公式 :)</div>
  </div>
</div>
