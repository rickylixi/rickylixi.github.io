...
\begin{frame}\frametitle{}
\begin{block}{}
3、公式$\forall xyz(Rxy\wedge Rxz\to Ryz)$在下面哪个图上为真?
\begin{enumerate}[A.]\setlength{\itemsep}{-2pt}
\item \dots
\item \dots
\item \dots
...
\end{block}
\begin{block}{}
4、一个岛上有``君子''、``小人''两类人. ``君子''只说真话, ``小人''只说假话. 你来岛上遇到了一个土著小帅. 小帅说: ``我是君子''. 这时又来了一个土著小美. 你想请小帅去问下小美的身份. 小帅问过小美后, 回来对你说: ``她说她是君子''. 下面哪一项为真?
\begin{enumerate}[A.]\setlength{\itemsep}{-2pt}
\item 小帅是君子, 小美是小人.
\item \dots
\item \dots
